import style from '../customer-request/customer-request.module.css'
...
const CustomerRequest = () => {
  ...
  const getEmpHandler = () => {
    axios({
      ...
      alert("No Employee available with the selected service")
    }
  ...
  return (
    <div className={style.container} >
      <select value={id} onClick={onClickHandler} onChange={changehandler} className={style.container1}>
        {category.map((data) => {
          return (
            <>
              <option className={style.main}>
